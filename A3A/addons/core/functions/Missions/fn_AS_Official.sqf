...
if (!alive _official) then {
	...
	Debug("deaggroEvent | Rebels won a kill the official mission");
	
	// GAMERARMY: Lower aggro on completion, this just makes sense (official)
	[_faction, -15, 120] remoteExec ["A3A_fnc_addAggression",2];
