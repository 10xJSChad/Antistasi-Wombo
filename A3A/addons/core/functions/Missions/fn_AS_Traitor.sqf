...
if (!alive _traitor || {traitorIntel}) then {
    ...
    Debug("deaggroEvent | Rebels won a traitor mission");
	// GAMERARMY: Lower aggro on completion, this just makes sense
	[Occupants, -1 * (15 * _factor), 120] remoteExec ["A3A_fnc_addAggression",2];
